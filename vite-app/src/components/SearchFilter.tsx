    ...
    <div className="space-y-3">
      ...
      <form onSubmit={handleSearch}>
        ...
        >
          ...
          <div 
            className={`absolute top-full left-0 right-0 mt-2 transition-all duration-300 ${
              showFilters ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-2 pointer-events-none'
            }`}
          >
            <div className="bg-black/90 backdrop-blur-xl border border-white/10 rounded-2xl p-3 shadow-2xl">
