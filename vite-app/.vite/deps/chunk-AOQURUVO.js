...
var ICONS = {
  add: async () => (await import("./add-IEUNCS7G.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-MFRASRNV.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-SEWZCF4M.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-MCXTWWUK.js")).appStoreSvg,
  apple: async () => (await import("./apple-WFD4KVMY.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-KFCALFQL.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-O6ELUFS6.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-HQIWOK3F.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-R3WESBUT.js")).arrowTopSvg,
  bank: async () => (await import("./bank-GX4WRLYJ.js")).bankSvg,
  browser: async () => (await import("./browser-VO4BMML3.js")).browserSvg,
  card: async () => (await import("./card-ORBYIT5P.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-WRF6MRS6.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-DBRD2OBU.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-PQZK3P5O.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-D3M2GRSH.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-CGKNH4YN.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-QHKZRQ2O.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-ISJ7RJXX.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-3G4TFEJN.js")).clockSvg,
  close: async () => (await import("./close-PSR666DN.js")).closeSvg,
  compass: async () => (await import("./compass-CBYBOFK6.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-CHBO7XPJ.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-E345NH7Z.js")).copySvg,
  cursor: async () => (await import("./cursor-44SRQDJQ.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-E3WXD52W.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-W6J27VUX.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-JUDM4JLF.js")).disconnectSvg,
  discord: async () => (await import("./discord-A2G3NIDN.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-RLJZEVD2.js")).etherscanSvg,
  extension: async () => (await import("./extension-GV7GCREL.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-HE4KH2KW.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-ZCENV7MP.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-ETNASA33.js")).farcasterSvg,
  filters: async () => (await import("./filters-DAJTZM4R.js")).filtersSvg,
  github: async () => (await import("./github-3Q7E4YXW.js")).githubSvg,
  google: async () => (await import("./google-U4CFJG23.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-Z3SVZK6H.js")).helpCircleSvg,
  image: async () => (await import("./image-YP6LWXBD.js")).imageSvg,
  id: async () => (await import("./id-RNV3YSOZ.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-WHWR4E57.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-XCFTGMV2.js")).lightbulbSvg,
  mail: async () => (await import("./mail-PXXVK2DL.js")).mailSvg,
  mobile: async () => (await import("./mobile-RFD3CQ22.js")).mobileSvg,
  more: async () => (await import("./more-CGK3DRQJ.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-L5LRG7WK.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-WHVLTSGZ.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-3XSIJ6V2.js")).offSvg,
  playStore: async () => (await import("./play-store-74QPLTBX.js")).playStoreSvg,
  plus: async () => (await import("./plus-IU3ZNP2E.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-JGVGPABC.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-S4CVR5BV.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-C27ECV3M.js")).refreshSvg,
  search: async () => (await import("./search-ITTZEFK2.js")).searchSvg,
  send: async () => (await import("./send-VGRR5ZXG.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-G4HETA26.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-2KDGABJH.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-ZV23V5JC.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-N5IZQBKF.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-JPQWQCCF.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-MGYOZR55.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-HYEH4EZ2.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-WEKKIGYB.js")).twitchSvg,
  twitter: async () => (await import("./x-ILAKSA2V.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-JM4PQLUY.js")).twitterIconSvg,
  verify: async () => (await import("./verify-D42HICZ4.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-H2GBPDGB.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-K44OD5K3.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-UIVFL4OU.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-UIVFL4OU.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-UIVFL4OU.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-OWQOINIV.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-IZZXV7MM.js")).warningCircleSvg,
  x: async () => (await import("./x-ILAKSA2V.js")).xSvg,
  info: async () => (await import("./info-SBRK52UU.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-H62CO2JB.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-TDPRBJVH.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-AOQURUVO.js.map
